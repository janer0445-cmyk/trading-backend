...
// --- Database connection (Render + Supabase will give credentials) ---
const pool = new Pool({
...
app.post("/signup", async (req, res) => {
  ...
  try {
    const result = await pool.query(
      ...
      [email, hashedPassword, 1000] // default demo balance
    );
...
// --- Start server ---
app.listen(5000, () => {
  console.log("Trading backend running on port 5000 🚀");
});
